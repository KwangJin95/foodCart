...
<div class="container mt-4" style="width:380px">
	...
	<div>
		<form method="post">
			<div class="label mb-2">아이디</div>
			<input class="mb-3 w-100" type="text" name="id" placeholder=" 아이디를 입력해주세요.">

			<div class="label mb-2">핸드폰 번호</div>
			<input class="mb-3 w-100" type="text" name="phone" placeholder=" 010과 - 을 포함한 13자리 숫자로 작성해주세요.">

			<div class="label mb-2">이메일</div>
			<input class="mb-3 w-100" type="text" name="email" placeholder=" @를 꼭 포함해주세요.">

			<div class="mb-3">
				<span class="label float-left"> 주소 : </span> 
				<span>
					<select name="address" class="float-right">
						<optgroup label="서울">
			...
			<br>
			<div class="label mb-2">상세 주소</div>
			<input class="mb-3 w-100" type="text" name="address2" placeholder=" 상세 주소를 입력해주세요.">
			<br>
			
			<input type="button" class="pinkBtn" value="입력하기" onclick="checkValues(this.form)">
...
window.onkeydown = function() {
	...
	if(kcode == 116)
		location.href = "controller?type=findPasswordPage";
}
</script>
<br><br><br>
</body>
